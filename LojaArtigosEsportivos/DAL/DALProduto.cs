...
namespace LojaArtigosEsportivos
{
    public class DALProduto
    {
        ...
        public DataTable LocalizaPorMarca(String valor)
        {
            DataTable tabela = new DataTable();
            MySqlDataAdapter dadosCalcado = new MySqlDataAdapter("select id_produto,modelo,preco,quantidade,descricao,categoria,marca,nome_fornecedor from produto where produto.marca like '%" + valor + "%'", conn);

            dadosCalcado.Fill(tabela);
            return tabela;
        }
        public DataTable LocalizaPorModelo(String valor)
        {
            DataTable tabela = new DataTable();
            MySqlDataAdapter dadosCalcado = new MySqlDataAdapter("select id_produto,modelo,preco,quantidade,descricao,categoria,marca,nome_fornecedor from produto where produto.modelo like '%" + valor + "%'", conn);
