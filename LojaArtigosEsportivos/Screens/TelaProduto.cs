...
namespace LojaArtigosEsportivos
{
    public partial class TelaProduto : Form
    {
        ...
        LocalizaDevolucao localizaDevolucao = null;
        void localizaDevolucao_Disposed_1(object sender, EventArgs e)
        {
            localizaDevolucao = null;
        }
        ...
        private void devolucaoProdutoBtn_Click(object sender, EventArgs e)
        {
            if (localizaDevolucao == null)
            {
                localizaDevolucao = new LocalizaDevolucao();
                localizaDevolucao.Disposed += new EventHandler(localizaDevolucao_Disposed_1);
                localizaDevolucao.Show();
            }
        }
    }
}
