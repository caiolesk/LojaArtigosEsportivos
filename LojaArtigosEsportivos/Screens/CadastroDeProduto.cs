...
namespace LojaArtigosEsportivos
{
    public partial class CadastroDeProduto : Form
    {
        ...
        void cadastroDeCategoria_Disposed_1(object sender, EventArgs e)
        {
        ...
        private void novaCategoriaBtn_Click(object sender, EventArgs e)
        {
            if (cadastroDeCategoria == null)
            {
                cadastroDeCategoria = new CadastroDeCategoria();
                cadastroDeCategoria.Disposed += new EventHandler(cadastroDeCategoria_Disposed_1);
